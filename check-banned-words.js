...
var currentUserMessage = botContext.getCurrentUserMessage();
...
var lowerMessage = currentUserMessage.toLowerCase();
var found = false;
...
if (bannedWords && bannedWords.length) {
  for (var i = 0; i < bannedWords.length; i++) {
    ...
    if (regex.test(currentUserMessage)) {
      found = true;
      break;
    }
  }
...
if (found) {
  //botContext.sendMessage("Inappropriate content detected.");
  botContext.setTriggerNextMessage("Sensitive Topic");
} else {
  //botContext.sendMessage("Message is clean.");
}
}
